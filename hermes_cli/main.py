...
""",
    ...
    dashboard_parser.add_argument(
        "--password",
        default=None,
        help="Set HTTP Basic Auth password for internet-exposed access (username: hermes). Also set via HERMES_DASHBOARD_PASSWORD env var or dashboard.password in config.yaml",
    )
